package com.webpluz.command
{
	...
	{
		[Inject]
		public var event:PayloadEvent; //how does this Inject work ?
		[Inject]
		public var manager:IProxyManager;
		...
		override public function execute():void
		{
			...
			if (manager)
			{
				...
				var config:ProxyConfigs=new ProxyConfigs(event.payload.server, uint(event.payload.port), event.payload.autoConfigURL, event.payload.enabled);
